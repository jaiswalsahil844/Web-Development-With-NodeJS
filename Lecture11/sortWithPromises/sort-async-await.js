...
async function task() {
    ...
    try {
        ...
        let p1 = fs.readFile(__dirname + '/input1.txt');
        let p2 = fs.readFile(__dirname + '/input2.txt');
        let p3 = fs.readFile(__dirname + '/input3.txt');
        ...
        await fs.writeFile(__dirname + '/output.txt', sorted);
